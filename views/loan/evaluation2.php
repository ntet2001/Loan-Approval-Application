<?php
    ...
    WHERE statut=3 AND client.id_agence='$idAgence'";
    ...
    if (isset($array[5]) && isset($array[4]) && isset($array[0])) {
        ...
        if (isset($_POST['envoyer'])) {
            if (!empty($_POST['opinion'])) {
                ...
                $queryUpdateEngagement="UPDATE engagement SET statut=4 WHERE num_dossier='$array[0]'";
        ...
        <h1 style="text-align: center;margin-bottom:20px;">2nd Evaluation</h1>
            <div class="formulaire" style="margin-bottom: 20px;">
                <form action="./evaluation2.php" method="post">
                    ...
                    <button type="submit" class="btn btn-success" name="envoyer">Send To 3rd Evaluation</button>
                </form>
            </div>
    </main>
</body>
