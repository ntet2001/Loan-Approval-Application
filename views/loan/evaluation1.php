<?php
    ...
    WHERE statut=2 AND client.id_agence='$idAgence'";
    ...
    if (isset($array[5]) && isset($array[4]) && isset($array[0])) {
        ...
        if (isset($_POST['envoyer'])) {
            if (!empty($_POST['opinion'])) {
                ...
                $queryUpdateEngagement="UPDATE engagement SET statut=3 WHERE num_dossier='$array[0]'";
...
<body>
    <main class="container" style="margin-top: 90px;">
        <h1 style="text-align: center;margin-bottom:20px;">1st Evaluation</h1>
            <div class="formulaire" style="margin-bottom: 20px;">
                <form action="./evaluation1.php" method="post">
                    <div class="row">
                        <!---info client-->
                        <div class="col-lg-6">
                    ...
                    <button type="submit" class="btn btn-success" name="envoyer">Send To 2nd Evaluation</button>
                </form>
            </div>
    </main>
</body>
