<?php
    ...
    if (!empty($_POST['nomTypePret'])) {
        ...
        $queryInsert="INSERT INTO typePret (nom_typePret) VALUES('$data[0]')";
        ...
        <form action="indexType.php" method="post" style="margin-bottom: 50px;">
            <div class="row">
                <div class="form-group col-lg-6">
                    <label for="nomTypePret"><h5>Enter type of loan:</h5></label>
                    <input type="text" name="nomTypePret" id="nomTypePret" class="form-control">
                </div>
            </div>
            <?=$erreur?> <br>
                ...
                <table id="example" class="table table-hover table-bordered table-triped">
                    ...
                    <tbody>
                        <?php while(odbc_fetch_row($resultatTypePret)):?>
                            <?php
                                $idTypePret=odbc_result($resultatTypePret,'id_typePret');    
                                $nomTypePret=odbc_result($resultatTypePret,'nom_typePret');    
                            ?>
                            <tr>
                                <td><?=$idTypePret?></td>
                                <td><?=$nomTypePret?></td>
                                <td>
                                    <a href=<?="./updateType.php?id=".$idTypePret?> class="btn btn-warning">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                        </svg> Modify
                                    </a> 
                                    <a href=<?="./deleteType.php?id=".$idTypePret?> class="btn btn-danger">
