...
<body>
    <main class="container" style="margin-top: 90px;">
        <h1 style="text-align: center;margin-bottom:20px;">3rd Evaluation Of The Loan Request</h1>
            <div class="formulaire" style="margin-bottom: 20px;">
                <form action="./evaluation3.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="decisionchef">Send To</label>
                        <select name="decisionchef" id="decisionchef" class="form-control">
