<?php
    ...
    $select=odbc_exec($connexion,"SELECT [id_but],[nom_but] FROM [db_gestion_credit].[dbo].[but];");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="collapse navbar-collapse" id="monMenu">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#">Purpose Loan</a>
        ...
        <form action="indexbut.php" method="post" style="margin-bottom: 50px;">
            <div class="row">
                <div class="form-group col-lg-6">
                    <input type="file" name="importerbut" id="importerbut">
                </div>
            </div> 
                ...
                <table id="example" class="table table-hover table-bordered table-triped">
                    ...
                    <tbody>
                        <?php while (odbc_fetch_row($select)):?>
                            <?php $idbut=odbc_result($select,"id_but");?>
                            <?php $nombut=odbc_result($select,"nom_but");?>
                            <tr>
                                <td><?=$idbut?></td>
                                <td><?=$nombut?></td>
                            </tr>
