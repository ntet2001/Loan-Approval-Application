            ...
            <div class="col-lg-6">
                <form action="indexPole.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="nomPole" id="nomPole" class="form-control"><br>
                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>NTA</td>
                            <td>Cam</td>
                            <td><a href="./updatePole.php" class="btn btn-warning">Modifier</a> <a href="./deletePole.php" class="btn btn-danger">Supprimer</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
